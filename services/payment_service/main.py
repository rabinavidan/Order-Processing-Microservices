...
from consumer import IN_TOPIC, PaymentConsumer
...
if __name__ == "__main__":
    ...
    dlq_producer = DLQProducer(bootstrap_servers, source_topic=IN_TOPIC, consumer_group="payment-group")
    downstream_producer = PaymentProducer(bootstrap_servers)
    relay = OutboxRelay(session_factory, producer=downstream_producer)
    consumer = PaymentConsumer(bootstrap_servers, dlq_producer=dlq_producer, session_factory=session_factory)
